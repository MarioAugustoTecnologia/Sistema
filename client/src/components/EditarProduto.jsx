...
const EditarProduto = () => {
  ...
  useEffect(() => {
    fetch("https://sistemagestaocomercial.onrender.com/produtos/" + produtocod).then((res) => {
      return res.json();
    }).then((resp) => {
      idchange(resp.id);
  ...
  useEffect(() => {
    fetch("https://sistemagestaocomercial.onrender.com/catproduto").then((res) => {
      ...
      if (isValidate()) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            fetch("https://sistemagestaocomercial.onrender.com/produtos/" + produtocod, {
              method: "PUT",
