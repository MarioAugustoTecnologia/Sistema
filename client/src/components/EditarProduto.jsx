...
const EditarProduto = () => {
  ...
  useEffect(() => {
    fetch("https://sistema-p7bl.onrender.com/produtos/" + produtocod).then((res) => {
      return res.json();
    }).then((resp) => {
      idchange(resp.id);
  ...
  useEffect(() => {
    fetch("https://sistema-p7bl.onrender.com/catproduto").then((res) => {
      ...
      if (isValidate()) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            fetch("https://sistema-p7bl.onrender.com/produtos/" + produtocod, {
              method: "PUT",
