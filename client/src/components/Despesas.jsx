...
const Despesas = () => {
  ...
  useEffect(() => {
    fetch("https://sistema-p7bl.onrender.com/despesas").then((res) => {
  ...
  const handleDelete = (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch("https://sistema-p7bl.onrender.com/despesas/" + id, {
  ...
  function somar() {
    ...
    fetch("https://sistema-p7bl.onrender.com/despesas", {
      method: "POST",
