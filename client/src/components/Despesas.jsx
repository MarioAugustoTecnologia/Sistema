...
const Despesas = () => {
  ...
  useEffect(() => {
    fetch("https://sistemagestaocomercial.onrender.com/despesas").then((res) => {
  ...
  const handleDelete = (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch("https://sistemagestaocomercial.onrender.com/despesas/" + id, {
  ...
  function somar() {
    ...
    fetch("https://sistemagestaocomercial.onrender.com/despesas", {
      method: "POST",
