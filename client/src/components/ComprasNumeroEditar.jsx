...
const ComprasNumeroEditar = () => {
  ...
  useEffect(() => {
    fetch("https://sistema-p7bl.onrender.com/compras/" + compracod).then((res) => {
      return res.json();
    }).then((resp) => {
  ...
  useEffect(() => {
    fetch("https://sistema-p7bl.onrender.com/fornecedor").then((res) => {
        ...
        if (parcelamento === "" || parcelamento === null && parcela === "" || parcela === null && parcelan === "" || parcelan === null) {
          ...
          if (valorpag > total) {
            ...
            if (isValidate()) {
              ...
              fetch("https://sistema-p7bl.onrender.com/compras/" + compracod, {
                method: "PUT",
          ...
          if (isValidate()) {
            ...
            {
              fetch("https://sistema-p7bl.onrender.com/compras", {
                method: "POST",
                headers: { 'content-type': 'application/json' },
