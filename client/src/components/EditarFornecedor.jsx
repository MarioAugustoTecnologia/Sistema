...
const EditarFornecedor = () => {
    ...
    useEffect(() => {
        fetch("https://sistema-p7bl.onrender.com/fornecedor/" + forcod).then((res) => {
            return res.json();
        }).then((resp) => {
            idchange(resp.id);
    ...
    useEffect(() => {
        fetch("https://sistema-p7bl.onrender.com/catfornecedor").then((res) => {
        ...
        if (isValidate()) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch("https://sistema-p7bl.onrender.com/fornecedor/" + forcod, {
                        method: "PUT",
